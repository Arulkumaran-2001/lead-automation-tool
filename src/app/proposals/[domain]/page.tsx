  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center font-inter">
        <div className="animate-pulse text-sm font-semibold">Generating Formal Proposal and SOW for {cleanDomain}...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 font-inter p-4 sm:p-8 print:p-0 print:bg-white">
      ...
      <div className="max-w-4xl mx-auto mb-6 flex flex-col sm:flex-row justify-between items-center gap-3 bg-slate-900 text-white p-4 rounded-2xl shadow-xl print:hidden">
        <div>
          <h1 className="font-bold text-sm font-poppins">Formal Project Proposal and Statement of Work (SOW)</h1>
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            ...
            <span>Print or Save Proposal as PDF</span>
          </button>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 rounded-2xl shadow-2xl border border-slate-200 print:shadow-none print:border-none print:p-0 print:max-w-full space-y-8">
        ...
        <div className="border-b-2 border-blue-600 pb-6 flex flex-col sm:flex-row justify-between items-start gap-4 sm:gap-0">
          <div>
            ...
            <h1 className="text-xl sm:text-3xl font-extrabold text-slate-900 font-poppins tracking-tight">
              Digital Transformation and Conversion Engineering
            </h1>
          ...
          <div className="space-y-4 text-xs">
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
              <h3 className="font-bold text-slate-900 text-xs font-poppins mb-1">
                Phase 1: Core Performance Acceleration and Security Hardening (Weeks 1-2)
              </h3>
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
              <h3 className="font-bold text-slate-900 text-xs font-poppins mb-1">
                Phase 2: AI Lead Qualification Chatbot and Conversion Funnel (Weeks 2-3)
              </h3>
              <ul className="list-disc list-inside text-slate-700 space-y-1 text-[11px]">
                <li>Embed custom AI Customer Support Chatbot to qualify after-hours website inquiries automatically.</li>
                <li>Streamline contact form UX to boost conversion rates on mobile devices.</li>
                <li>Integrate automated email notifications and CRM webhook synchronization.</li>
              </ul>
            </div>

            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
              <h3 className="font-bold text-slate-900 text-xs font-poppins mb-1">
                Phase 3: Search Engine Optimization and GEO Schema Markup (Weeks 3-4)
              </h3>
              <ul className="list-disc list-inside text-slate-700 space-y-1 text-[11px]">
                <li>Inject JSON-LD structured data schema for LocalBusiness, Organization, and Service offerings.</li>
                <li>Optimize metadata, OpenGraph tags, and semantic HTML5 hierarchy for Google and AI answer engines.</li>
        ...
        {/* Investment and Milestones Table */}
        <section>
          <h2 className="text-sm font-extrabold text-slate-900 uppercase tracking-wider font-poppins mb-3 border-b border-slate-200 pb-1">
            3. Project Investment and Milestone Breakdown
          </h2>
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="bg-slate-100 text-slate-700 font-bold font-poppins">
                  <th className="p-3 border border-slate-200">Milestone Deliverable</th>
                  <th className="p-3 border border-slate-200">Timeline</th>
                  <th className="p-3 border border-slate-200">Investment Allocation</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-200 text-slate-700">
                <tr>
                  <td className="p-3 border border-slate-200 font-semibold">Deposit and Phase 1 (Performance and Security)</td>
                  <td className="p-3 border border-slate-200">Week 1-2</td>
                  <td className="p-3 border border-slate-200 font-bold text-slate-900">40% Upfront</td>
                </tr>
                <tr className="bg-slate-50/50">
                  <td className="p-3 border border-slate-200 font-semibold">Phase 2 (AI Chatbot and CRO Funnel)</td>
                  <td className="p-3 border border-slate-200">Week 2-3</td>
                  <td className="p-3 border border-slate-200 font-bold text-slate-900">40% Midway</td>
                </tr>
                <tr>
                  <td className="p-3 border border-slate-200 font-semibold">Phase 3 (SEO/GEO Schema and Final Delivery)</td>
                  <td className="p-3 border border-slate-200">Week 3-4</td>
                  <td className="p-3 border border-slate-200 font-bold text-slate-900">20% Upon Sign-off</td>
                </tr>
                <tr className="bg-blue-50/60 font-bold text-blue-900 font-poppins">
                  <td className="p-3 border border-slate-200">Estimated Total Project Investment ({country})</td>
                  <td className="p-3 border border-slate-200"></td>
                  <td className="p-3 border border-slate-200 text-sm text-blue-600 font-extrabold">{investment}</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="border-t border-slate-300 pt-6">
          <h2 className="text-sm font-extrabold text-slate-900 uppercase tracking-wider font-poppins mb-4">
            5. Formal Acceptance and Sign-Off
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 text-xs">
            <div className="space-y-2">
              <span className="font-bold text-slate-900 block font-poppins">For RoamWork Technologies:</span>
              <div className="pt-4 border-b border-slate-400 font-semibold text-slate-800">
                Arul Kumaran, Managing Director
              </div>
              <div className="text-slate-500">Date: August 7, 2026</div>
            </div>

            <div className="space-y-2">
              <span className="font-bold text-slate-900 block font-poppins">Accepted for {businessName}:</span>
              <div className="pt-4 border-b border-slate-400 text-slate-400 italic">
                Authorized Signature: ______________________
              </div>
              <div className="text-slate-400">Name and Title: ______________________</div>
              <div className="text-slate-400">Date: ______________________</div>
            </div>
          </div>
        </section>
      </div>
